...
export class UserApi extends runtime.BaseAPI {
     ...
     * Delete user
     */
    async userUsernameDeleteRaw(requestParameters: UserUsernameDeleteRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.username === null || requestParameters.username === undefined) {
     ...
     * Delete user
     */
    async userUsernameDelete(requestParameters: UserUsernameDeleteRequest): Promise<void> {
        await this.userUsernameDeleteRaw(requestParameters);
    }
